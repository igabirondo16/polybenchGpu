...
void cl_launch_kernel2(int k, int n, int gpu_end)
{
	if (k < (_PB_N-1))
	{
		size_t localWorkSize[2], globalWorkSize[2];
...
void lu_partial(int n, int start_row, int end_row, DATA_TYPE POLYBENCH_2D(A,N,N,n,n))
{
	int i, j, k;
...
int main(int argc, char *argv[])
{
	...
	init_array(n, POLYBENCH_ARRAY(A_outputFromGpu));
